...
def test_forward_pass_beats_pretraining_predictor():
    ...
    # kept_mask: True for kept (unmasked) patches, False for masked
    kept_mask = torch.zeros(2, 96, dtype=torch.bool)
    kept_mask[:, :24] = True  # first 24 patches are kept
    pred = beats_predictor(unmasked_patch_rep, patch_len, restore_ids, kept_mask)
